...
public class GithubHealthCheck implements HealthCheck {
    ...
    public void check() throws HealthCheckException {
        ...
        try {
            GithubConfig githubConfig = new GithubConfig("https://github.fkinternal.com/api/v3","ghe-admin","3b1121fd4d11859f0794059927d3eedbb68d4194","R,py", null,"/tmp/script-cache");
