...
public class GithubClient {
    ...
    public static void main(String[] args) throws Exception {
        GithubClient githubClient = new GithubClient(new GithubConfig("https://github.fkinternal.com/api/v3","appanasatya","fb5bcd5926c1bc6970cd7de9c1bd8f42d92e24ea", null, "R,py","/tmp/script-cache"));
